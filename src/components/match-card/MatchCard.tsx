...
export const MatchCard = forwardRef<HTMLDivElement, MatchCardProps>(
  ({ match, isMobile }, ref) => {
    ...
    const onFormChange = (e: any, field: any) => {
      ...
      console.log({ FieldChanged: e.target.value, Field: matchForm, isMobile:isMobile });
    };
    ...
    const onEditMatch = () => {
      let winner =
        Number(matchForm.team1_runs) > Number(matchForm.team2_runs)
          ? match.team1
          : match.team2;
    ...
    return (
      <Card className="match-card" ref={ref}>
        <div className="team-container">
          <div className="team-summary">
            ...
            <div>
              <div className="team-name-position">
                <div className="px-1 ">{match.team1}</div>
                {team1Position && (
                  <p
                    className={
                      team1Position <= 4 ? "text-green-700" : "text-red-700"
                    }
                  >
                    #{team1Position}
                  </p>
          ...
          {!editMatch && match.editable && match.team1_overs == 0 && (
            <div>0/0 (0.0)</div>
          )}
          ...
          {!editMatch &&
            match.editable &&
            match.team1_overs == 0 &&
            match.editable && <div>0/0 (0.0)</div>}
          {editMatch && match.editable && (
            <div className="match-form">
              <input
                type="number"
          ...
          <div className="team-summary">
            ...
            <div className="team-name-position">
                <div className="px-1 ">{match.team2}</div>
                {team2Position && (
                  <p
                    className={
                      team2Position <= 4 ? "text-green-700" : "text-red-700"
                    }
                  >
                    #{team2Position}
                  </p>
            ...
            {/* {team2Position && <div className={team2Position<=4 ? 'text-green-700': 'text-red-700'}># {team2Position}</div>} */}
          </div>
        </div>
        <div className="match-summary">
          ...
          {(!match.editable || match.team1_overs != 0) &&
            !superOver &&
          ...
          {(!match.editable || match.team1_overs != 0) && superOver && (
            <div>{matchForm.super_over_winner} won in Super Over</div>
          )}
